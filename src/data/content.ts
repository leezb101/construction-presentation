...
export const resourceFlows: ResourcePoolFlow[] = [
  {
    id: "workers-east",
    title: "人员派发",
    summary: "人员先入总池，再按班次派发到项目。",
    from: "系统总池",
    to: "东线项目",
    type: "人员池",
    count: 18,
    note: "当班人员统一实名校验后，从总池派发到项目，工时只在当前项目生效。",
    rule: "先入总池，再派发到项目。",
    status: "校验后派发",
  },
  {
    id: "helmets-reuse",
    title: "帽子复用",
    summary: "安全帽先回池解绑，再绑定到新项目。",
    from: "东线项目",
    to: "西线项目",
    type: "帽子池",
    count: 12,
    note: "安全帽结束旧班次后先回池，再按新班次重新绑定，复用过程全程留痕。",
    rule: "先解绑回池，再绑定新项目。",
    status: "回池后重绑",
  },
  {
    id: "machine-transfer",
    title: "机械转场",
    summary: "机械可转场复用，但工时和成本分段计量。",
    from: "东线项目",
    to: "西线项目",
    type: "机械池",
    count: 1,
    note: "机械可在项目间转场复用，系统会自动切换工时和成本归属。",
    rule: "可转场复用，但工时分段计量。",
    status: "转场后切段",
  },
];
